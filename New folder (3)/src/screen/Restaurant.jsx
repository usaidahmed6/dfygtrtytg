...
import { DeleteOutlined, EllipsisOutlined, UploadOutlined, RollbackOutlined } from '@ant-design/icons';
import { Select } from 'antd';
import Meta from 'antd/lib/card/Meta';

import { addDoc, userRef3, getDownloadURL, ref, storage, getDocs, uploadBytes, userRef4, auth, collection, db, deleteDoc, doc, onSnapshot } from './firebase';
...
export const Restaurant = () => {
    ...
    const onCreate = async (values) => {
        ...
        const collectionImage = await uploadImageToFirebase(values.upload[0].originFileObj)
        if (collectionImage) {
    ...
    const getFoodOrder = async () => {
        console.log('uid hey???', auth.currentUser.uid)
        const q = await query(userRef4, where("uid", "==", auth.currentUser.uid))
        const querySnapshot = await getDocs(q);
        let orders = []
        querySnapshot.forEach((doc) => {
            // doc.data() is never undefined for query doc snapshots
        ...
        <div className='main'>
...

            {
                loading ?
                    ...
                    :
                    <>
                        <h1 className="heading text-center"> Restaurant <span> Dishes </span> </h1>
                                            ...
                                            return (
                                                ...
                                                <div className="box" key={index}>
                                                    ...
                                                    <div className="content">
                                                        ...
                                                        <span className="btn-co" onClick={() => deleteDocument(data.id)}>delete</span>
                                                    </div>
                                                </div>
                            ...
                            <div className="col-xl-12">
                                <div className="card mb-4">
                                    ...
                                    <div className="card-body col-xl-12">
                                        <table className='col-xl-12' id='table'>
                                            <thead>
                                                <tr>
                                                    <th>Food Name</th>
                                                    <th>Price</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td> <Radio.Group onChange={onChange} value={value}>
